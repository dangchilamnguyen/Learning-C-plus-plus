...
double calculate_fee(vehicle vehicle);
    ...
    int vehicle_count)
{
    ...
    write_line(
        "The clock has been advanced by " +
        to_string(hours) +
        " hours.");
